...
class Ui_Form(QWidget):  #将object改为QWidget，才能弹出消息对话框
    ...
    def setupUi(self, Form):
        ...
        self.pushButton.setStyleSheet("QPushButton{border-image: url(icon/botton.bmp)}") #绑定图片
        ...
        self.pushButton_2.setStyleSheet("QPushButton{border-image: url(icon/botton.bmp)}") #绑定图片
        ...
        self.pushButton_face_pass.setStyleSheet("QPushButton{border-image: url(icon/botton.bmp)}") #绑定图片
        ...
        self.pushButton_face_input.setStyleSheet("QPushButton{border-image: url(icon/botton.bmp)}") #绑定图片
        ...
        self.pushButton_register.setStyleSheet("QPushButton{border-image: url(icon/botton.bmp)}") #绑定图片
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_register.setText(_translate("Form", "账号密码注册"))
